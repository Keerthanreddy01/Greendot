...
class SmsService {
  ...
  Future<bool> sendDealConfirmationSMS(
    String phoneNumber,
    String farmerName,
    String crop,
    double amount,
...
''';
  ...
  Future<bool> sendTeamAssignmentSMS(
    String phoneNumber,
    String farmerName,
...
''';
  ...
  Future<bool> sendWeatherAlertSMS(
    String phoneNumber,
    String farmerName,
    String weatherAlert,
...
''';
  ...
  Future<bool> sendHarvestReminderSMS(
    String phoneNumber,
    String farmerName,
    String crop,
    String harvestDate,
...
''';
  ...
  Future<bool> sendTaskReminderSMS(
    String phoneNumber,
    String farmerName,
    String taskTitle,
    String taskTime,
